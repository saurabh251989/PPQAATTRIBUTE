...
public class ReadExcel {
	...
	static String getModuleNumber(String moduleName) throws IOException {
		...
		if (moduleName.toLowerCase().startsWith("fcp_ab_")) {
			moduleName = moduleName.replace("fcp_ab_", "");

			moduleName = "fcp_ab\\" + moduleName.toLowerCase();
		}
		else {
		...
		File myFile = new File("Input/input.xlsx");
